  ...
  return (
    ...
    >
      ...
      <p className="mt-8 max-w-xl text-lg text-muted-foreground sm:pl-12">
        ...
        reach me is email. Feel free to reach out about opportunities or just to talk about any
        of the projects above.
      </p>
      <div className="mt-8 flex flex-wrap items-center gap-4 sm:pl-12">
        <Button size="lg" className="h-12 rounded-full px-6 text-base" asChild>
